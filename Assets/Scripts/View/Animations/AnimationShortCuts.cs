...
public static class AnimationShortCuts
{
    ...
    public static Tween ShakeRotationAnimation(this Transform transform, ShakeAnimationPreset preset)
    {
        return transform
    ...
    public static Tween ShakePositionAnimation(this Transform transform, ShakeAnimationPreset preset)
    {
        return transform
